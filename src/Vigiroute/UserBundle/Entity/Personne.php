...
namespace Vigiroute\UserBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Vigiroute\UserBundle\Repository\PersonneRepository")
 */
class Personne
{
    /**
     ...
     * @var int
     *
     * @ORM\Column(name="numeroCni", type="integer")
     */
    private $numeroCni;
